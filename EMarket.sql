...
CREATE TABLE `Produtos` (
  ...
  KEY `Produtos_FornecedorID` (`FornecedorID`),
  KEY `Produtos_FornecedoresProdutos` (`FornecedorID`),
  ...
  CONSTRAINT `FK_Produtos_Fornecedores` FOREIGN KEY (`FornecedorID`) REFERENCES `Fornecedores` (`FornecedorID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Produtos`
--
INSERT INTO `Produtos` (`ProdutoID`,`ProdutoNome`,`FornecedorID`,`CategoriaID`,`QuantidadePorUnidade`,`PrecoUnitario`,`UnidadesEstoque`,`UnidadesPedidas`,`NivelReabastecimento`,`Descontinuado`) VALUES 
...
CREATE TABLE `Fornecedores` (
  ...
  KEY `Fornecedores_Empresa` (`Empresa`),
  KEY `Fornecedores_PostalCode` (`CodigoPostal`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `Fornecedores`
--
INSERT INTO `Fornecedores` (`FornecedorID`,`Empresa`,`Contato`,`Titulo`,`Endereco`,`Cidade`,`Regioes`,`CodigoPostal`,`Pais`,`Telefone`,`Fax`,`Pagina`) VALUES 
